...
bool MyLayer::init() {
    ...
    auto background = createLayerBG(); // USING GEODE FUNCTIONS FOR SIMPLICITY
    ...
    auto backBtn = addBackButton(this); // USING GEODE FUNCTIONS FOR SIMPLICITY - onBack FUNCTION NOT NEEDED ANYMORE!
